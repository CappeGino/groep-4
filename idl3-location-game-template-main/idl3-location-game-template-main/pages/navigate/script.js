...
function changeColor(buttonNumber) {
  ...
  var selectedButton = document.querySelector('.round-button:nth-child(' + buttonNumber + ')');
  selectedButton.classList.add('selected');
    ...
    var map = new mapboxgl.Map({
        container: 'map',
        style: 'mapbox://styles/daliruno/clp6zcjgm00gk01qx9rch4wo0', // Hier kun je het kaartstijl-ID aanpassen
        center: [0, 0], // Beginpunt van de kaart (lengtegraad, breedtegraad)
